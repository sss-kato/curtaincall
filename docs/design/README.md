...
| [D-04](D-04.md) | app 基盤設計（feature 構成・drift スキーマ・Riverpod / DI・HTTP・FCM 購読・100 件保持・通知許可） | app | F-02, F-05〜F-11 / R-6 | D-01 | S-00, S-01, S-02, S-03 | reviewed | 23 |
| [D-05](D-05.md) | app 機能設計（UseCase 一覧・画面遷移・S-00〜S-03 の対応表・既読 / 保存 / フィルタ / ブラウザ選択） | app | F-01〜F-08, F-10, F-11 | D-01, D-04 | S-00, S-01, S-02, S-03 | draft | 15 |
